...
nb_train_samples = 9453
nb_validation_samples = 2013
nb_filters1 = 32
nb_filters2 = 32
nb_filters3 = 64
conv1_size = 3
...
Tensorboard log
"""
target_dir = "./models/weights-improvement-{epoch:02d}.hdf5"
print(target_dir)
...
checkpoint = ModelCheckpoint(target_dir, monitor='val_accurancy', verbose=1, save_best_only=True, mode='max')
